...
def test__call_contract_function():
    ...
    name = chain.call_contract_function(
        "0x6b175474e89094c44da98b954eedeac495271d0f", "name"
    )
...
def test__load_abi():
    ...
    abi_name = chain.load_abi(
        "0x6b175474e89094c44da98b954eedeac495271d0f", abi_name="token"
    )
    assert abi == abi_name
...
def test__get_events_for_contract():
    chain = EthereumMainnetChain(
        rpc_nodes=RPC_NODES, etherscan_api_key=ETHERSCAN_API_KEY
    )

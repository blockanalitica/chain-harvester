...
from chain_harvester_async.adapters.alchemy_chain import AlchemyChain
...
async def test_get_transactions_for_contracts():
    ...
    transactions = alchemy.get_transactions_for_contracts([USDT_CONTRACT], 23865575, 23865575)
